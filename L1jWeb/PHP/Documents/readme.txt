L1JTW變更說明:
1.編碼改為utf8.
2.變更密碼加密編碼方式以符合L1JTW密碼變動(原l1j Rev2012可用的加密編碼仍有保留寫法).
3.變更部份變數名稱.
4.admin與 admin_tools 目錄中 htaccess 檔案需手動改回 .htaccess(SVN無法上傳.htaccess).
5.Documents 目錄中 test.php 為密碼編碼顯示工具 可用於對照密碼編碼是否有誤.
7.image目錄中 map.7z 為降低 SVN 流量請自行解壓縮.

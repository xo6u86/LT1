...
if($err_count==0){
	$str="insert into `zwls_event_announce` (`gmaccount` , `eventname` , `eventstarttime` , `eventstoptime` , `eventhelp` , `eventitemhelp` , `datetime` , `gmip`) values ('$id','$eventname','$eventstarttime','$eventstoptime','$eventhelp','$eventitemhelp','$time','$ip')";
	$db->query($str);
	$msg=$msg."申請完成<br>";
}
?>

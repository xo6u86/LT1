...
<?if($err_count==0){?>
<form method="post" action="resetloc_save.php" name="form1" onsubmit="B1.disabled=1">
<input type="hidden" name="code" value="<?=$code?>">
	<tr>
		<td width="100%" bgcolor=#303030><div align="center"><font size=2 color=red>卡點自救</font></div></td>
	</tr>
	<tr>
		<td width="100%" bgcolor=#202020><div align="left">角色卡點自救，使用後該帳號內所有角色均會被傳送至銀騎士村莊。</div></td>
	</tr>
	<tr>

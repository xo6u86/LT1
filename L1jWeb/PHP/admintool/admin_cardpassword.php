...
<?if($err_count==0){?>
<form method="post" action="admin_cardpassword_save.php" name="form1" onsubmit="B1.disabled=1">
<input type="hidden" name="password" value="<?=$password?>">
	<tr>
		<td width="100%" bgcolor=#303030><div align="center"><font size=2 color=red>序號查詢(管理介面)</font></div></td>
	</tr>
	<tr>
		<td width="100%" bgcolor=#202020><div align="left">選擇：<select size="1" name="searchmode" style="color: #ffffff; background-color: #191919; border:1 solid #ffffff">
<option value="1">註冊碼</option>
<option value="2">物品序號</option>
<option value="3">點數序號</option>
</select>
</div></td>
	</tr>
	<tr>

<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="OnLine.aspx.vb" Inherits="Rank_OnLine" title="未命名頁面" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="5" summary="排版表格">
        <tr>
            <td style="text-align:center">目前線上名單</td>
        </tr>
        <tr>
            <td>

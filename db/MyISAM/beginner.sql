...
(4, 40383, 1, 0, 0, '地圖：歌う島', 'P'),
(5, 40378, 1, 0, 0, '地圖：エルフの森', 'E'),
(6, 40380, 1, 0, 0, '地圖：シルバーナイトの村', 'E'),
(7, 40384, 1, 0, 0, '地圖：隱された溪谷', 'K'),
(8, 40383, 1, 0, 0, '地圖：歌う島', 'W'),
(9, 40389, 1, 0, 0, '地圖：沈默の洞窟', 'D'),
(10, 40383, 1, 0, 0, '地圖：歌う島', 'D');

...
public class SpeedHackLogFormatter extends Formatter {
	...
	public String format(LogRecord record) {
		...
		for (Object p : record.getParameters()) {
			...
			if (p instanceof L1PcInstance) {
				...
				StringUtil.append(output, pc.getNetConnection().getIp(), pc.getAccountName(), pc.getName(), " [" + String.valueOf(pc.getId()) + "]");
			} else {

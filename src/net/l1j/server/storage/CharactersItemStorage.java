 ...
 */
package net.l1j.server.storage;

import javolution.util.FastTable;

import net.l1j.server.model.instance.L1ItemInstance;
import net.l1j.server.storage.mysql.MySqlCharactersItemStorage;

public abstract class CharactersItemStorage {
	public abstract FastTable<L1ItemInstance> loadItems(int objId) throws Exception;

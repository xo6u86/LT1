...
public class C_NPCAction extends ClientBasePacket {
	...
	public C_NPCAction(byte abyte0[], ClientThread client) throws Exception {
		...
		if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 50016) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 70997) { // ドロモンド
			if (s.equalsIgnoreCase("0")) { // ありがとう、旅立ちます
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 70999) { // アレックス(歌う島)
			if (s.equalsIgnoreCase("1")) { // ドロモンドの紹介狀を渡す
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71002) { // キャンセレーション師
			if (s.equalsIgnoreCase("0")) { // キャンセレーション魔法をかけてもらう
				if (pc.getLevel() <= 13) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71005) { // ポピレア(歌う島)
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71006) { // ティミー(歌う島)
			if (s.equalsIgnoreCase("0")) {
				if (pc.getLevel() > 25) {
					htmlid = "jpe0057";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71036) { // カミーラ(海賊島)
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71038) { // 長老 ノナメ
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71039) { // ドゥダ-マラ ブウ
			if (s.equalsIgnoreCase("teleportURL")) { // 「わかりました、その場所に送ってください」
				htmlid = "orcfbuwoo2";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71040) { // 調查團長 アトゥバ ノア
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71041) { // ネルガ フウモ
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71042) { // ネルガ バクモ
			if (s.equalsIgnoreCase("A")) { // 「調查をします」
				L1NpcInstance npc = (L1NpcInstance) obj;
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71043) { // ドゥダ-マラ ブカ
			if (s.equalsIgnoreCase("A")) { // 「調查をします」
				L1NpcInstance npc = (L1NpcInstance) obj;
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71044) { // ドゥダ-マラ カメ
			if (s.equalsIgnoreCase("A")) { // 「調查をします」
				L1NpcInstance npc = (L1NpcInstance) obj;
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71055) { // ルケイン(海賊島)
			if (s.equalsIgnoreCase("0")) { // アイテムを受け取る
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71057) { // ドイル(海賊島)
			if (s.equalsIgnoreCase("3")) { // ラッシュについて聞く
				htmlid = "doil4";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71059) { // ルディアン(海賊島)
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71060) { // レスタ(海賊島)
			if (s.equalsIgnoreCase("A")) { // 仲間たちについて
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71061) { // カドムス(海賊島)
			if (s.equalsIgnoreCase("A")) { // 地圖を組み合わせてください
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71063) { // 小さな箱-1番目
			if (s.equalsIgnoreCase("0")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71074) { // リザードマンの長老(海賊島)
			if (s.equalsIgnoreCase("A")) { // その戰士は今どこらへんにいるんですか？
				htmlid = "lelder5";
				pc.getQuest().set_step(L1Quest.QUEST_LIZARD, 1);
			} else if (s.equalsIgnoreCase("B")) { // 寶を取り戾してきます
				htmlid = "lelder10";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71078) { // ポワール
			if (s.equalsIgnoreCase("teleportURL")) { // 「入ってみる」
				htmlid = "usender2";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71080) { // 治安團長アミス
			if (s.equalsIgnoreCase("teleportURL")) { // 「私がお手伝いしましょう」
				htmlid = "amisoo2";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71089) { // フランコ(海賊島)
			...
			if (s.equalsIgnoreCase("a")) { // はい、武器とスクロールをください
				htmlid = "";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71126) { // 補佐官イリス
			if (s.equalsIgnoreCase("B")) { // 「はい。私がご協力しましょう」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71128) { // 鍊金術師 ペリター
			if (s.equals("A")) {
				if (pc.getInventory().checkItem(41010, 1)) { // イリスの推薦書
					htmlid = "perita2";
				} else {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71129) { // 寶石細工師 ルームィス
			if (s.equals("Z")) {
				htmlid = "rumtis2";
			} else if (s.equals("Y")) {
				if (pc.getInventory().checkItem(41010, 1)) { // イリスの推薦書
				...
				if (pc.getInventory().checkItem(41161, 1)) { // ミステリアスブラックイアリング
					htmlid = "rumtis6";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("B")) {
				if (pc.getInventory().checkItem(41164, 1)) { // ミステリアスウィザードイアリング
					htmlid = "rumtis7";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("C")) {
				if (pc.getInventory().checkItem(41167, 1)) { // ミステリアスグレーウィザードイアリング
					htmlid = "rumtis8";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("T")) {
				if (pc.getInventory().checkItem(41167, 1)) { // ミステリアスホワイトウィザードイアリング
					htmlid = "rumtis9";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("w")) {
				if (pc.getInventory().checkItem(41162, 1)) { // ミステリアスブラックイアリング
					htmlid = "rumtis14";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("x")) {
				if (pc.getInventory().checkItem(41165, 1)) { // ミステリアスナイトイアリング
					htmlid = "rumtis15";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("y")) {
				if (pc.getInventory().checkItem(41168, 1)) { // ミステリアスグレーナイトイアリング
					htmlid = "rumtis16";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("z")) {
				if (pc.getInventory().checkItem(41171, 1)) { // ミステリアスホワイトナイトイアリング
					htmlid = "rumtis17";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("U")) {
				if (pc.getInventory().checkItem(41163, 1)) { // ミステリアスブラックイアリング
					htmlid = "rumtis10";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("V")) {
				if (pc.getInventory().checkItem(41166, 1)) { // ミステリアスウォーリアイアリング
					htmlid = "rumtis11";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("W")) {
				if (pc.getInventory().checkItem(41169, 1)) { // ミステリアスグレーウォーリアイアリング
					htmlid = "rumtis12";
				} else {
					htmlid = "rumtis101";
				}
			} else if (s.equals("X")) {
				if (pc.getInventory().checkItem(41172, 1)) { // ミステリアスホワイウォーリアイアリング
					htmlid = "rumtis13";
				} else {
					htmlid = "rumtis101";
				}
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71170) { // 長老隨行員クロレンス
			if (s.equalsIgnoreCase("request las weapon manual")) { // 「ラスタバドの歷史書を渡す」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71181) { //示愛任務-奇岩-愛瑪伊
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71182) { //示愛任務-奇岩-伊森
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71198) { // 傭兵團長 ティオン
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71199) { // ジェロン
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71252) { // ゾウのストーンゴーレム
			int weapon1 = 0;
			int weapon2 = 0;
			int newWeapon = 0;
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71253) { // 底比斯沙漠 宙斯之石頭高崙
			if (s.equalsIgnoreCase("A")) { // 龜裂之核製作
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71255) { // 底比斯祭壇守門人
			int map782pccount = 0;
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 71258) { // 遠征隊遺物
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80048) { // 空間の歪み
			if (s.equalsIgnoreCase("2")) { // 「やめる」
				htmlid = "";
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80049) { // 搖らぐ者
			if (s.equalsIgnoreCase("1")) { // 「バルログの意志を迎え入れる」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80050) { // ヤヒの執政官
			if (s.equalsIgnoreCase("1")) { // 「私の靈魂はヤヒ樣へ…」
				htmlid = "meet105";
			} else if (s.equalsIgnoreCase("2")) { // 「私の靈魂をかけてヤヒ樣に忠誠を誓います…」
				if (pc.getInventory().checkItem(40718)) { // ブラッドクリスタルの欠片
					htmlid = "meet106";
				} else {
					htmlid = "meet110";
				}
			} else if (s.equalsIgnoreCase("a")) { // 「ブラッドクリスタルの欠片を1個捧げます」
			...
			} else if (s.equalsIgnoreCase("b")) { // 「ブラッドクリスタルの欠片を10個捧げます」
			...
			} else if (s.equalsIgnoreCase("c")) { // 「ブラッドクリスタルの欠片を100個捧げます」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80053) { // ヤヒの鍛冶屋
			if (s.equalsIgnoreCase("a")) { // 「材料すべてを用意できました」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80055) { // ヤヒの補佐官
			L1NpcInstance npc = (L1NpcInstance) obj;
			htmlid = getYaheeAmulet(pc, npc, s);
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80056) { // 業の管理者
			L1NpcInstance npc = (L1NpcInstance) obj;
			if (pc.getKarma() <= -10000000) {
				getBloodCrystalByKarma(pc, npc, s);
			}
			htmlid = "";
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80057) { // アルフォンス
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80064) { // バルログの執政官
			if (s.equalsIgnoreCase("1")) { // 「私の永遠の主はバルログ樣だけです…」
				htmlid = "meet005";
			} else if (s.equalsIgnoreCase("2")) { // 「私の靈魂をかけてバルログ樣に忠誠を誓います…」
				if (pc.getInventory().checkItem(40678)) { // ソウルクリスタルの欠片
					htmlid = "meet006";
				} else {
					htmlid = "meet010";
				}
			} else if (s.equalsIgnoreCase("a")) { // 「ソウルクリスタルの欠片を1個捧げます」
			...
			} else if (s.equalsIgnoreCase("b")) { // 「ソウルクリスタルの欠片を10個捧げます」
			...
			} else if (s.equalsIgnoreCase("c")) { // 「ソウルクリスタルの欠片を100個捧げます」
			...
			if (s.equalsIgnoreCase("1")) { // 「カヘルの意志を受け入れる」
				if (pc.getKarma() >= 10000000) {
					pc.setKarma(-1000000);
					pc.sendPackets(new S_ServerMessage(SystemMessageId.$1079));
					htmlid = "betray03";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80067) { // 諜報員(欲望の洞窟側)
			if (s.equalsIgnoreCase("n")) { // 「動搖しつつも承諾する」
				htmlid = "";
				poly(client, 6034);
			...
			} else if (s.equalsIgnoreCase("d")) { // 「そんな任務はやめる」
				htmlid = "minicod09";
				pc.getInventory().consumeItem(41130, 1);
				pc.getInventory().consumeItem(41131, 1);
			} else if (s.equalsIgnoreCase("k")) { // 「初期化する」
				htmlid = "";
			...
			} else if (s.equalsIgnoreCase("g")) { // プレゼントをもらう
				htmlid = "";
				L1ItemInstance item = pc.getInventory().storeItem(41130, 1); // 血痕の契約書
				pc.sendPackets(new S_ServerMessage(SystemMessageId.$143, ((L1NpcInstance) obj).getNpcTemplate().get_name(), item.getItem().getName()));
			}
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80071) { // バルログの補佐官
			L1NpcInstance npc = (L1NpcInstance) obj;
			htmlid = getBarlogEarring(pc, npc, s);
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80072) { // バルログの鍛冶屋
			String sEquals = null;
			int karmaLevel = 0;
			int[] material = null;
			int[] count = null;
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80074) { // 業の管理者
			L1NpcInstance npc = (L1NpcInstance) obj;
			if (pc.getKarma() >= 10000000) {
				getSoulCrystalByKarma(pc, npc, s);
			}
			htmlid = "";
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80076) { // 倒れた航海士
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80079) { // 占星術師ケプリシャ
			if (s.equalsIgnoreCase("0")) { // ケプリシャと魂の契約を結ぶ
			...
			} else if (s.equalsIgnoreCase("1")) { // 援助金を出して運勢を見る
			...
			} else if (s.equalsIgnoreCase("2")) { // ケプリシャから祝福を受ける
			...
			} else if (s.equalsIgnoreCase("3")) { // 壺を割って契約を破棄する
				if (pc.getInventory().checkItem(41312)) { // 占星術師の壺
			...
			} else if (s.equalsIgnoreCase("S")) { // 「短くて輕い釣り竿」
				if (pc.getInventory().checkItem(ItemId.ADENA, 1000)) {
					materials = new int[] { ItemId.ADENA };
					counts = new int[] { 1000 };
			...
			*/
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80099) { //哈蒙任務
			if (s.equalsIgnoreCase("A")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80105) { // アデン騎馬團員
			if (s.equalsIgnoreCase("c")) { // 「新たな力をくださいる」
				if (pc.isCrown()) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80135) { // エルラス
			if (pc.isDragonKnight()) {
				if (s.equalsIgnoreCase("a")) { // 「オーク密使変身スクロールを受け取る」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80136) { // 長老 プロケル
			...
			if (pc.isDragonKnight()) {
				if (s.equalsIgnoreCase("a") && lv15_step == 0) { // 「プロケルの課題を遂行する」
					...
					htmlid = "prokel9";
				} else if (s.equalsIgnoreCase("e")) { // 「鉱物の袋が必要だ」
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 80145) { // 長老 シルレイン
			if (pc.isDragonKnight()) { // 龍騎士任務
				int lv45_step = pc.getQuest().get_step(L1Quest.QUEST_LEVEL45);
				if (s.equalsIgnoreCase("l") && lv45_step == 1) { // 「プロケルの手紙を渡す」
			...
			} else if (pc.isIllusionist()) { // 幻術士任務
				if (s.equalsIgnoreCase("a")) {
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 81202) { // 諜報員(影の神殿側)
			if (s.equalsIgnoreCase("n")) { // 「頭にくるが承諾する」
				htmlid = "";
				poly(client, 6035);
			...
			} else if (s.equalsIgnoreCase("g")) { // 素早く受取る
				htmlid = "";
		...
		} else if (((L1NpcInstance) obj).getNpcTemplate().get_npcId() == 90520) { // 庫庫爾坎 宙斯之石頭高崙
			if (s.equalsIgnoreCase("A")) { // 龜裂之核製作
				if (pc.getInventory().checkItem(49101, 100)) {
					materials = new int[] { 49101 };
					counts = new int[] { 100 };

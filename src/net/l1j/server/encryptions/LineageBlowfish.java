...
public class LineageBlowfish {
	...
	private static int P_SIZE = 18; // P.length;

	private static int S_SIZE = 256;
	...
	public static long[] blowfish_init(long[] keys) {
		...
		int index = 0;
		int index2 = i;
		for (j = 0; j < S_SIZE * 2; j++, i += 2, index2 += 2) {
			blowfish_encrypt(v, w);

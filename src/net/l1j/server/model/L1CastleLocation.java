...
//	private static final int WW_TOWER_Y = 33408; // 3.0 位置
	...
	public static int[] getCastleLoc(int castle_id) { // castle_idから城內の座標を返す
		int[] loc = new int[3];
	...
	// このメソッドはアデン時間で一日每に更新される稅率を返卻する。(リアルタイムな稅率ではない)

...
public class L1ActId {
	...
	/** 空手被打動作 */
	public static final int ACT_2 = 2;
	/** 1.待機 */
	public static final int ACT_3 = 3;
	/** 1.出現 2.高崙石頭躲藏 3.拿劍走路動作 */
	public static final int ACT_4 = 4;
	/** 拿劍攻擊動作 */
	public static final int ACT_5 = 5;
	/** 拿劍被打動作 */
	public static final int ACT_6 = 6;
	/** 拿劍待機 */
	public static final int ACT_7 = 7;
	/** 死亡動作 */
	public static final int ACT_8 = 8;
	/** 1.躲藏 2.拿斧頭走路動作 */
	public static final int ACT_11 = 11;
	/** 拿斧頭攻擊動作 */
	public static final int ACT_12 = 12;
	/** 1.隱藏 被打 2.拿斧頭被打動作 */
	public static final int ACT_13 = 13;
	/** 1.隱藏 呼吸 2.拿斧待機 */
	public static final int ACT_14 = 14;
	/** 撿取物品 */
	public static final int ACT_15 = 15;
	/** 投擲 */
	public static final int ACT_16 = 16;
	/** 使用魔杖 */
	public static final int ACT_17 = 17;
	/** 有向魔法 */
	public static final int ACT_18 = 18;
	/** 無向魔法 */

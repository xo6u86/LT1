...
public class L1Cooking {
	...
	public static void useCookingItem(L1PcInstance pc, L1ItemInstance item) {
		...
		if (itemId == 41277 || itemId == 41285) { // フローティングアイステーキ
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 41280 || itemId == 41288) { // 蟻腳のチーズ燒き
			if (itemId == 41280) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 41283 || itemId == 41291) { // 豬肉の串燒き
			if (itemId == 41283) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49052 || itemId == 49060) { // キウィパロット燒き
			if (itemId == 49052) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49053 || itemId == 49061) { // スコーピオン燒き
			if (itemId == 49053) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49055 || itemId == 49063) { // クモ腳の串燒き
			if (itemId == 49055) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49244 || itemId == 49252) { // クラスタシアンのハサミ燒き
			if (itemId == 49244) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49245 || itemId == 49253) { // グリフォン燒き
			if (itemId == 49245) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49247 || itemId == 49255) { // タートルドラゴン燒き
			if (itemId == 49247) {
			...
			eatCooking(pc, cookingId, time);
		} else if (itemId == 49249 || itemId == 49257) { // ドレイク燒き
			if (itemId == 49249) {
	...
	public static void eatCooking(L1PcInstance pc, int cookingId, int time) {
		...
		if (cookingId == COOKING_1_0_N || cookingId == COOKING_1_0_S) { // フローティングアイステーキ
			...
			cookingType = 2;
		} else if (cookingId == COOKING_1_3_N || cookingId == COOKING_1_3_S) { // 蟻腳のチーズ燒き
			cookingType = 3;
			pc.addAc(-1);
			...
			cookingType = 5;
		} else if (cookingId == COOKING_1_6_N || cookingId == COOKING_1_6_S) { // 豬肉の串燒き
			cookingType = 6;
			pc.addMr(5);
			...
			pc.addMaxMp(30);
			pc.sendPackets(new S_MPUpdate(pc.getCurrentMp(), pc.getMaxMp()));
		} else if (cookingId == COOKING_2_2_N || cookingId == COOKING_2_2_S) { // タートルドラゴンの果子
			cookingType = 10;
			pc.addAc(-2);
			pc.sendPackets(new S_OwnCharStatus(pc));
		} else if (cookingId == COOKING_2_3_N || cookingId == COOKING_2_3_S) { // キウィパロット燒き
			cookingType = 11;
		} else if (cookingId == COOKING_2_4_N || cookingId == COOKING_2_4_S) { // スコーピオン燒き
			cookingType = 12;
		} else if (cookingId == COOKING_2_5_N || cookingId == COOKING_2_5_S) { // イレッカドムシチュー
			cookingType = 13;
			pc.addMr(10);
			pc.sendPackets(new S_SPMR(pc));
		} else if (cookingId == COOKING_2_6_N || cookingId == COOKING_2_6_S) { // クモ腳の串燒き
			cookingType = 14;
			pc.addSp(1);
			pc.sendPackets(new S_SPMR(pc));
		} else if (cookingId == COOKING_2_7_N || cookingId == COOKING_2_7_S) { // クラブスープ
			cookingType = 15;
		} else if (cookingId == COOKING_3_0_N || cookingId == COOKING_3_0_S) { // クラスタシアンのハサミ燒き
			cookingType = 16;
		} else if (cookingId == COOKING_3_1_N || cookingId == COOKING_3_1_S) { // グリフォン燒き
			cookingType = 17;
			pc.addMaxHp(50);
			pc.sendPackets(new S_HPUpdate(pc.getCurrentHp(), pc.getMaxHp()));
			if (pc.isInParty()) { // パーティー中
			...
			cookingType = 18;
		} else if (cookingId == COOKING_3_3_N || cookingId == COOKING_3_3_S) { // タートルドラゴン燒き
			cookingType = 19;
			pc.addAc(-3);
			pc.sendPackets(new S_OwnCharStatus(pc));
			...
			pc.addEarth(10);
			pc.sendPackets(new S_OwnCharAttrDef(pc));
		} else if (cookingId == COOKING_3_5_N || cookingId == COOKING_3_5_S) { // ドレイク燒き
			cookingType = 21;
			pc.addSp(2);
			pc.sendPackets(new S_SPMR(pc));

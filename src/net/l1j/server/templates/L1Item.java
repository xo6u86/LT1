...
public abstract class L1Item implements Serializable {
	 ...
	 * アイテムの素材を返す
	 * 
	 * @return 0:none 1:液体 2:web 3:植物性 4:動物性 5:紙 6:布 7:皮 8:木 9:骨 10:龍の鱗 11:鐵
	 *         12:鋼鐵 13:銅 14:銀 15:金 16:プラチナ 17:ミスリル 18:ブラックミスリル 19:ガラス 20:寶石
	 *         21:礦物 22:オリハルコン
	 */
	...
	private int _gfxId; // ● インベントリ內のグラフィックＩＤ
	...
	/**
	 * アイテムの個數が變化した際にすぐにDBに書き⑸むべきかを返す。
	 */
	...
	private boolean _useRoyal = false; // ● ロイヤルクラスが裝備できるか
	...
	private boolean _useKnight = false; // ● ナイトクラスが裝備できるか
	...
	private boolean _useElf = false; // ● エルフクラスが裝備できるか
	...
	private boolean _useMage = false; // ● メイジクラスが裝備できるか
	...
	private boolean _useDarkelf = false; // ● ダークエルフクラスが裝備できるか
	...
	public int get_addstr() {
		return _addstr;
	}

	public void set_addstr(int addstr) {
		_addstr = addstr;
	}

	private int _adddex = 0; // ● ＤＥＸ補正

	public int get_adddex() {
		return _adddex;
	}

	public void set_adddex(int adddex) {
		_adddex = adddex;
	}

	private int _addcon = 0; // ● ＣＯＮ補正

	public int get_addcon() {
		return _addcon;
	}

	public void set_addcon(int addcon) {
		_addcon = addcon;
	}

	private int _addint = 0; // ● ＩＮＴ補正

	public int get_addint() {
		return _addint;
	}

	public void set_addint(int addint) {
		_addint = addint;
	}

	private int _addwis = 0; // ● ＷＩＳ補正

	public int get_addwis() {
		return _addwis;
	}

	public void set_addwis(int addwis) {
		_addwis = addwis;
	}

	private int _addcha = 0; // ● ＣＨＡ補正

	public int get_addcha() {
		return _addcha;
	}

	public void set_addcha(int addcha) {
		_addcha = addcha;
	}
	...
	private boolean _isHasteItem = false; // ● ヘイスト效果の有無

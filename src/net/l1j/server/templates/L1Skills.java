...
public class L1Skills {
	...
	private int _reuseDelay; // 單位：ミリ秒
	...
	private int _buffDuration; // 單位：秒
	...
	private int _targetTo; // 對象 0:自分 1:PC 2:NPC 4:血盟 8:パーティ 16:ペット 32:場所
	...
	/**
	 * スキルの屬性を返す。<br>
	 * 0.無屬性魔法,1.地魔法,2.火魔法,4.水魔法,8.風魔法,16.光魔法
	 */
	public int getAttr() {
		return _attr;
	}
	...
	/**
	 * スキルの作用の種類を返す。<br>
	 * 1.確率系,2.エンチャント,4.咒い,8.死,16.治療,32.復活,64.攻擊,128.その他特殊
	 */
	public int getType() {
		return _type;
	}
